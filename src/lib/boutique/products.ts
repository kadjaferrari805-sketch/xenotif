...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    images: ['https://images.pexels.com/photos/18195548/pexels-photo-18195548.jpeg?auto=compress&cs=tinysrgb&w=800'],
  ...
  {
    id: 'c3', slug: 'eclairage-velo-led-usb',
    name: 'Éclairage Vélo LED Rechargeable — Avant + Arrière',
    brand: 'ROCKBROS',
    description: 'Set phare avant + feu arrière LED, rechargeables USB. Puissant, étanche, plusieurs modes. Voir et être vu en toute sécurité.',
    longDescription: 'Rouler de nuit ou par faible visibilité exige d\'être vu. Ce set complet réunit un phare avant puissant et un feu arrière rouge, tous deux rechargeables en USB (fini les piles). Plusieurs modes d\'éclairage (fixe, clignotant, éco) pour adapter l\'autonomie. Fixations en silicone universelles, sans outil, qui s\'adaptent à tous les diamètres de guidon et de tige de selle. Boîtiers étanches IPX5 résistants à la pluie.',
    type: 'physical', price_cents: 2490, original_price_cents: 3490, stripe_price_id: 'price_aff_eclairage_velo',
    images: ['https://images.pexels.com/photos/15545040/pexels-photo-15545040.jpeg?auto=compress&cs=tinysrgb&w=800'],
    badge: '🔦 Visibilité', category: 'Équipements', rating: 4.7, reviews: 3582, inStock: true,
    tags: ['éclairage vélo', 'led', 'sécurité', 'cyclisme'],
    disciplines: ['cyclisme'],
    features: ['Avant + arrière inclus', 'Rechargeable USB', 'Plusieurs modes', 'Fixation sans outil', 'Étanche IPX5'],
    amazon: { asin: 'B07D7R8MZ9', affiliateUrl: amazonUrl('éclairage vélo led rechargeable usb') },
    isAffiliate: true,
  },
  {
  ...
  {
    id: 'c6', slug: 'kit-reparation-velo-pompe',
    name: 'Kit Réparation Crevaison + Mini-Pompe',
    brand: 'ROCKBROS',
    description: 'Mini-pompe haute pression, démonte-pneus, rustines et multi-outil. Tout pour réparer une crevaison où que tu sois.',
    longDescription: 'Une crevaison ne doit jamais gâcher une sortie. Ce kit compact réunit l\'essentiel : une mini-pompe haute pression (compatible valves Presta et Schrader), des démonte-pneus, un kit de rustines auto-adhésives et un multi-outil avec clés Allen. Le tout se range dans une sacoche de selle discrète. Léger et complet, c\'est l\'assurance de repartir en quelques minutes, même au milieu de nulle part.',
    type: 'physical', price_cents: 1990, original_price_cents: 2790, stripe_price_id: 'price_aff_kit_reparation_velo',
    images: ['https://images.pexels.com/photos/7153017/pexels-photo-7153017.jpeg?auto=compress&cs=tinysrgb&w=800'],
    badge: '🔧 Indispensable', category: 'Équipements', rating: 4.7, reviews: 1893, inStock: true,
    tags: ['kit réparation', 'pompe vélo', 'crevaison', 'cyclisme'],
    disciplines: ['cyclisme'],
    features: ['Mini-pompe Presta/Schrader', 'Démonte-pneus', 'Rustines auto-adhésives', 'Multi-outil Allen', 'Sacoche de selle incluse'],
    amazon: { asin: 'B07GST9X4N', affiliateUrl: amazonUrl('kit réparation vélo mini pompe') },
    isAffiliate: true,
  },
  {
