...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px;font-family:${font};">
  ...
  <tr><td style="padding:0 4px 16px;">
    <table role="presentation" width="100%"><tr>
      <td style="font-weight:900;font-size:21px;letter-spacing:3px;color:#ffffff;">XENOTIF<span style="color:#FF6B00;">®</span></td>
  ...
  <tr><td style="padding:0 4px;"><div style="height:3px;background:linear-gradient(90deg,#FF6B00 0%,#FF8A33 45%,rgba(255,107,0,0) 100%);border-radius:99px;"></div></td></tr>
...
export async function sendThemedDailyEmail({
  ...
  await resend.emails.send({
    ...
    html: wrap(`
      ...
      <table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="border-radius:99px;background:#FF6B00;">
    ...
    return `
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f1216;border:1px solid #232a33;border-radius:16px;margin:0 0 14px;">
        <tr><td style="padding:22px 24px;">
          <div style="font-weight:800;font-size:10px;letter-spacing:1.5px;color:#FF6B00;text-transform:uppercase;margin:0 0 7px;">${labels.badgeGuide}</div>
  ...
  const reviewHtml = reviewUrl ? `
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0f1216;border:1px solid #232a33;border-radius:16px;margin:18px 0 0;">
        <tr><td style="padding:22px 24px;">
          ...
          <a href="${reviewUrl}"
             style="display:inline-block;background:#FF6B00;color:#ffffff;padding:12px 24px;border-radius:10px;font-weight:700;font-size:14px;text-decoration:none;">
            ${labels.reviewCta}
          </a>
        </td></tr>
      </table>
