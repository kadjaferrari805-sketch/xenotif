...
const VARIANT_CLASS: Record<BadgeVariant, string> = {
  ...
  success: 'bg-emerald-50 border-emerald-200 text-sport-success',
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1 rounded-full border px-2.5 py-1 text-xxs font-bold uppercase tracking-wide',
