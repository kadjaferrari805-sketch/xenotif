  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {/* Indice « zoom » discret */}
        <span className="pointer-events-none absolute bottom-3 right-3 rounded-full bg-black/70 px-2.5 py-1 text-[11px] font-semibold text-white/90 opacity-0 transition-opacity group-hover:opacity-100">
          🔍 Survol pour zoomer
        </span>
      </div>
