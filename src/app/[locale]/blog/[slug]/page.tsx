...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `https://xenotif.com/blog/${post.slug}` },
    openGraph: {
      title: post.metaTitle,
      description: post.metaDescription,
      type: 'article',
      url: `https://xenotif.com/blog/${post.slug}`,
...
export default async function BlogPostPage({
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://xenotif.com/blog/${post.slug}`,
    },
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Accueil',
        item: 'https://xenotif.com',
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Blog',
        item: 'https://xenotif.com/blog',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: post.title,
        item: `https://xenotif.com/blog/${post.slug}`,
      },
    ],
  }
