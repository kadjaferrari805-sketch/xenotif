  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-sport-dark px-4 text-center">
      ...
      <div className="flex gap-3">
        ...
        <Link href="/" className="inline-flex items-center gap-2 rounded-xl border border-sport-border px-5 py-2.5 text-sm font-bold text-white hover:bg-sport-card transition-colors">
