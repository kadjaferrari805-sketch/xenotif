        ...
        {FEATURES.map(f => (
          ...
          >
            ...
            <span className="flex items-center gap-3">
              <span className={`text-2xs font-black uppercase tracking-wider px-2.5 py-1 rounded-full border ${minPlanBySlug.get(f.slug) === 'free' ? 'text-sport-success border-emerald-200 bg-emerald-50' : 'text-sport-orange border-sport-orange/30 bg-sport-orange/10'}`}>
